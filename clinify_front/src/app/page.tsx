  ...
  return (
    <>
      ...
      <Head>
        <title>
          {t("meta_home.title", {
            defaultValue: "Sorriso Care - Affordable Dental Care in Montenegro",
          })}
        </title>
        <meta
          name="description"
          content={t("meta_home.description", {
            defaultValue:
              "Sorriso Care provides world-class dental treatments at affordable prices. From implants to veneers, we ensure your perfect smile.",
          })}
        />
        <meta
          name="keywords"
          content={t("meta_home.keywords", {
            defaultValue:
              "affordable dental care, dental implants, veneers, Hollywood smile, Montenegro dentistry",
          })}
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://sorriso.care/" />
        ...
        <meta
          ...
          content={t("meta_home.og_title", {
            defaultValue: "Sorriso Care - Affordable Dental Care",
          })}
        />
        <meta
          property="og:description"
          content={t("meta_home.og_description", {
            defaultValue:
              "Get world-class dental treatments in Montenegro at affordable prices. Book your consultation today!",
          })}
        />
        <meta property="og:url" content="https://sorriso.care/" />
        <meta
        ...
        <meta
          ...
          content={t("meta_home.twitter_title", {
            defaultValue: "Sorriso Care - Affordable Dental Treatments",
          })}
        />
        <meta
          name="twitter:description"
          content={t("meta_home.twitter_description", {
            defaultValue:
              "Discover affordable dental care with implants, veneers, and more at Sorriso Care.",
          })}
        />
        <meta
          name="twitter:image"
