                ...
                <div className="grid grid-cols-3 gap-4">
                  <Link href="/contact">
                    <div className="flex flex-col items-center text-white">
                      <FontAwesomeIcon icon={faPlane} className="w-8 h-8 mb-2 md:w-12 md:h-12" />
                  ...
                  <Link href="/contact">
                    <div className="flex flex-col items-center text-white">
                      <FontAwesomeIcon icon={faHotel} className="w-8 h-8 mb-2 md:w-12 md:h-12" />
                      <span className="text-sm font-serif">
                  ...
                  <Link href="/contact">
                    <div className="flex flex-col items-center text-white">
                      <FontAwesomeIcon icon={faEye} className="w-8 h-8 mb-2 md:w-12 md:h-12" />
                      <span className="text-sm font-serif">
