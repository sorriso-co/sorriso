...
const DentalTravelIntro: React.FC = () => {
  ...
  return (
    <div className="relative bg-teal-50 py-20 s">
      ...
      <div className="container mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="md:w-1/2">
            <h2 className="text-5xl font-semibold text-teal-600 mb-10 font-serif">
              {t('dentalTravelIntro.title')}
            </h2>
            <p className="text-gray-600 text-2xl mb-10 font-serif font-light">
