...
//   const [modalItem, setModalItem] = useState<MediaItem | null>(null);
//   const [showFirstPlayButton, setShowFirstPlayButton] = useState(false);
//   const [showAllPlayButtons, setShowAllPlayButtons] = useState(false);

//   useEffect(() => {
//     const handleScroll = () => {
//       if (window.scrollY > 50) {
//         setShowFirstPlayButton(true);
//       } else {
//         setShowFirstPlayButton(false);
//         setShowAllPlayButtons(false);
//       }
//     };
...
//                   onClick={() => setModalItem(item)}
//                 />
//                 {/* Show play button conditionally */}
//                 {(showFirstPlayButton && index === 3) || showAllPlayButtons ? (
//                   <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
//                     <button
//                       className="bg-white p-3 rounded-full shadow-lg"
//                       onClick={() => {
//                         setModalItem(item);
//                         if (index === 3) handleFirstVideoClick();
//                       }}
//                     >
//                       <svg
//                         xmlns="http://www.w3.org/2000/svg"
