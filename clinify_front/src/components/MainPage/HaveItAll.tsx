  ...
  return (
    <section className="bg-transparent text-teal-800 py-20 px-8 lg:px-24">
      <div className="container mx-auto text-center max-w-4xl">
        {/* Title */}
        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-extrabold mb-8 leading-tight text-teal-700">
          {t("haveItAll.title", { defaultValue: "Have It All with Sorriso" })}
        </h2>

        {/* Description */}
        <p className="text-lg sm:text-xl lg:text-2xl font-light mb-12 leading-relaxed text-teal-800">
        ...
        <div className="flex justify-center">
          <Link href="/contact"
            className="inline-block bg-teal-500 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:bg-teal-600 hover:shadow-2xl transition-transform transform hover:scale-105 text-lg lg:text-xl transition-all duration-300">
