...
const TestimonialsHero: React.FC = () => {
  ...
  return (
    <section className="relative bg-gradient-to-r from-teal-800 via-teal-600 to-teal-800 py-16 md:py-24 px-10 text-white mt-20 rounded-t-[40px] overflow-hidden">
